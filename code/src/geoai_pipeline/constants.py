...
2. Every object must be a single concrete visible instance with an objective visual descriptor and need to have at least on adj. word before n. and some or a/an before
   (e.g., "blue street name sign", "yellow rear license plate", "red phone box").
...
REASONING: Signage & Text: 2 street name signs, some parking signs; Road Markings: some lane lines, a zebra crossing; Vehicles: a bus; Architecture: 3 white houses, a blue house; Vegetation: some tree in the left, a tree in front of parking sign, a grass plate; Infrastructure: 2 yellow bollard, a red bollard"""




YES_ID_RERUN_PROMPT = """You are an advanced geolocation model.
