...
if __name__ == "__main__":
    ...
    disable_torch_init()
    if args.model == 'cambrian':
        model_path = args.model_path or "nyu-visionx/cambrian-8b"
        ...
        model_path = args.model_path or 'liuhaotian/llava-v1.5-7b'
        model_name = get_model_name_from_path(model_path)
        tokenizer, model, image_processor, context_len = load_pretrained_model(model_path, args.model_base, model_name)
    elif args.model == 'llava_next':
        model_path = args.model_path or "lmms-lab/llava-onevision-qwen2-72b-ov"
        model_name = get_model_name_from_path(model_path)
        ...
        model_path = args.model_path or 'mgm/work_dirs/mgm13bhd'
        model_name = get_model_name_from_path(model_path)
